...
\begin{equation}
\mathrm{HU}=1000\frac{\mu-\mu_{\mathrm{water}}}{\mu_{\mathrm{water}}-\mu_{\mathrm{air}}},
...
Instead of these explicit regularisers, plug-and-play methods use a learned denoising step and alternate between data-consistency and denoising updates \cite{}, often with

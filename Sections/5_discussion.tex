...
Hu et al. reported PaDIS PSNRs of \(33.57\,\mathrm{dB}\) at 20 views and \(29.48\,\mathrm{dB}\) at 8 views \cite{hu_learning_2024}; our paper-style track reached \(32.71\) and \(27.15\,\mathrm{dB}\). Despite changed data and geometry, the 20-view result is within \(0.86\,\mathrm{dB}\), while the 8-view result substantially improves over FDK and CP-TV. PaDIS also generated coherent whole CT slices from patches, whereas fixed stitching and averaging produced less credible global anatomy, supporting randomly shifted partitions.
...
We did not reproduce the claim that PaDIS consistently outperforms whole-image diffusion \cite{hu_learning_2024}. In the paper-style track, whole-image diffusion exceeded PaDIS-DPS by \(1.26\,\mathrm{dB}\) at 20 views and \(1.95\,\mathrm{dB}\) at 8 views. LION-physics showed the same reversal under VE-DPS, also visible in \autoref{fig:results-ct20-additional} and \autoref{fig:results-ct8-additional}.

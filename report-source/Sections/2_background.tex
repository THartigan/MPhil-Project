...
This section introduces only the concepts needed to interpret the experiments. These are the CT forward problem and its missing-data regimes, variance-exploding diffusion priors, the PaDIS patch construction and the reconstruction algorithms used for comparison.
